...
function EditAddress() {
  ...
  const { setOpenEditAddress, dataEditAddress, address, setAddress } =
    useOpen();

  const formik = useFormik({
    initialValues: {
      names: dataEditAddress.names,
      surnames: dataEditAddress.surnames,
      address: dataEditAddress.address,
      specifications: dataEditAddress.specifications,
      neighborhood: dataEditAddress.neighborhood,
      state: dataEditAddress.state,
      city: dataEditAddress.city,
      phone: dataEditAddress.phone,
      userId: dataEditAddress.userId,
    },
  ...
  useEffect(() => {
    getCountryInfo();
    setIdDeparmentSelected(dataEditAddress.stateNumber);
  }, []);

...
//       if (response.status === 200) setOpenAddress(false);
//     },
//   });
...
//   return (
//     <div className="delete-alert flex items-center justify-center">
//       <form
//         onSubmit={formik.handleSubmit}
//         className="flex bg-white flex-col col-span-1  justify-center items-start gap-3 p-5 rounded-lg"
//       >
...
//             <p>Ingresa tus datos para registrar lugar de domicilio</p>
//           </div>
//         </div>

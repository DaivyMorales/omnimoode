...
function SidebarAddProduct() {
  ...
  const [statusSizeCreated, setStatusSizeCreated] = useState(0);
      ...
      if (onSelected !== 0) {
        ...
        if (productId) {
          ...
          if (response) {
            ...
            setProducts([...products, responseProductId.data]);
            setisLoading(false);
            setOpenAddProduct(false);
          }
        }
      } else if (onSelected === 0) {
            ...
            <div className="py-4 px-4">
              ...
              <div className="flex justify-center items-center flex-col gap-2">
                ...
                {formik.touched.imageUrl && formik.errors.imageUrl ? (
                  <p className="form-errors">{formik.errors.imageUrl}</p>
                ) : null}
              </div>
              ...
              <div className="flex flex-col gap-1 w-full">
                ...
                <p className="form-errors">
                  {categoryError && "Debes escojer una categoria"}
                </p>
              </div>
